...
const DocterPrescriptionMainScreen = ({ navigation }) => {
    ...
    <ScrollView style={theme.container}>
      ...
      <View style={styles.mainHeading}>
        <Text style={{ textAlign: "center" }} h4>
          Welcome to the Doctor Prescription Screen
        </Text>
      </View>
...
DocterPrescriptionMainScreen.navigationOptions = (screenProps) => ({
  title: "Home Screen",
...
export default DocterPrescriptionMainScreen;
