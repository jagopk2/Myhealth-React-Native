...
const UserHealthScreen = ({ navigation }) => {
    ...
    <ScrollView style={theme.container}>
      ...
      <View style={styles.mainHeading}>
        <Text style={{ textAlign: "center" }} h4>
          Welcome to the User Health platform
        </Text>
      </View>
      <SliderBox
      ...
      <View style={styles.mainItemsContainer}>
        ...
        <View style={styles.mainItems}>
          ...
          >
            <Text style={styles.mainItemsText}>Blood</Text>
            <Text style={styles.mainItemsText}>Pressure</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.customCard}
            onPress={() => {
          ...
          >
            <Text style={styles.mainItemsText}>Heart</Text>
            <Text style={styles.mainItemsText}>Rate</Text>
          </TouchableOpacity>
        </View>
        <View style={styles.mainItems}>
          <TouchableOpacity
          ...
          >
            <Text style={styles.mainItemsText}>Random</Text>
            <Text style={styles.mainItemsText}>Plasma Sugar</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.customCard}
            onPress={() => {
              navigation.navigate("UserHealthFlow", {
                type: "fasting_plasma_sugar",
              });
            }}
          >
            <Text style={styles.mainItemsText}>Fasting</Text>
            <Text style={styles.mainItemsText}>Plasma Sugar</Text>
          </TouchableOpacity>
        </View>
      </View>
...
UserHealthScreen.navigationOptions = (screenProps) => ({
  title: "Home Screen",
